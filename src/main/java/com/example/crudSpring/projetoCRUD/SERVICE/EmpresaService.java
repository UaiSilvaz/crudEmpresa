...
public class EmpresaService {
    ...
    //seleciona todas as empresas do banco de dados
     ...
     //empresaRepository: É uma referência a uma instância da classe EmpresaRepository. Esta instância é injetada automaticamente pelo Spring, geralmente no construtor da classe de serviço
...
//  1°                     2°                                FROM  3°                                      
// SELECT (QUAIS OS DADOS QUE EU QUERO RETORNAR?) (ONDE DESEJA EXECUTAR O COMANDO?)
